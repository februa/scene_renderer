...
class PropagationPath:
    ...
    このクラスは、伝搬後も音源基準の signal、到来方向 direction_world、絶対遅延 delay、経路 gain を保持する。
    signal shape は [n_sample]、direction_world shape は [3]、delay の単位は s である。
...
class PropagatedSource:
    ...
    paths の各 signal は同じ時間軸 shape [n_sample] を前提とする。
